...
{
    public partial class Zhjg_Zlbj_List : BasePageGuanli
    {
        #region 基本配置
        // 常量   
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                //数据绑定  
                WebCommon.DropDownListDataBind(this.DDL_jglx, true);
        ...
        private void powerGridViewDataBind(int pageIndex)
        {
            if (bIsBeFrom)
            {
                ihb.SearchInfo(InstanceHead + this.Gdv_ZlbjInfo.ID, arrParas, this, this.Gdv_ZlbjInfo.ID,pageIndex,20);
            }
            else
            {
                ihb.SearchInfo(InstanceHead + this.Gdv_ZlbjInfo.ID, null, this, this.Gdv_ZlbjInfo.ID,pageIndex,20);
            }
        }
