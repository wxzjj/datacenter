...
{
    public partial class Zhjg_Zbtb_List : BasePageGuanli
    {
        #region 基本配置
        // 常量   
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                WebCommon.DropDownListDataBind(this.DDL_TenderTypeNum, true);
                WebCommon.DropDownListDataBind(this.DDL_TenderClass, true);
        ...
        private void powerGridViewDataBind(int pageIndex)
        {
            if (bIsBeFrom)
            {
                ihb.SearchInfo(InstanceHead + this.Gdv_ZbtbInfo.ID, arrParas, this, this.Gdv_ZbtbInfo.ID,pageIndex,20);
            }
            else
            {
                ihb.SearchInfo(InstanceHead + this.Gdv_ZbtbInfo.ID,null, this,this.Gdv_ZbtbInfo.ID,pageIndex,20);
            }
        }
