...
left join uepp_jsdw c on a.jsdwid=c.jsdwid left join uepp_qyjbxx d on a.sgdwid=d.qyid
        ...
        public bool DeleteGzzshfById(string gzzsId)
        {
            ...
            string sql = "delete from  dbo.Szgkjc_Gzzs where GzzsId in (" + gzzsId + "); delete from  dbo.Szgkjc_Gzhf where GzzsId in (" 
        ...
        public bool DeleteDxjbById(string dxjbId)
        {
            ...
            string strParas = AntiSqlInjection.ParameterizeInClause(dxjbId, "@para", ref sp);

            string sql = "delete from Szgkjc_Dxjb where DxjbId in (" + strParas
                + "); delete from  Szgkjc_Dxjb_Sjml where DxjbId in ("  + strParas + ") ";
