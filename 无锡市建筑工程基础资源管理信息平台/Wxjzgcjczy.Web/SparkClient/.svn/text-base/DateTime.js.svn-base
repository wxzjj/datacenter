/*
从网上收集的js程序，为Bigdesk8中DataTimePicker控件所依赖。群耀软件
*/

//------------------ 样式定义 2650A6 ---------------------------//
//功能按钮同样样式white
var s_tiannet_turn_base = "height:16px;font-size:9pt;color:#000;border:0 solid #CCCCCC;cursor:hand;background-color:#9CF;";
//翻年、月等的按钮
...
//日期选择控件体的样式
var s_tiannet_body = "width:150;background-color:#9CF;display:none;z-index:9998;position:absolute;" +
...
//字体样式 FFCC00
var s_tiannet_font = "color:#000;font-size:9pt;cursor:hand;";
//链接的样式
var s_tiannet_link = "text-decoration:none;font-size:9pt;color:#9CF;";
//横线
var s_tiannet_line = "border-bottom:1 solid #6699CC";
//------------------ 变量定义 ---------------------------//
var tiannetYearSt = 1950; //可选择的开始年份
var tiannetYearEnd = 2099; //可选择的结束年份
...
document.write(' <tr style="background-color:#9CF;font-size:10pt;color:white;height:22px;" Author="tiannet">');
...
document.write('<td align="center" id="tdTiannetDay36" onClick="tiannetDay=this.innerText;tiannetSetValue(true);" '
    + ' style="' + s_tiannet_day + '">&nbsp;</td>');
document.write('<td align="right" colspan="5"><a href="javascript:tiannetToday();" style="' + s_tiannet_link + '">当天</a>' +
    '&nbsp;<a href="javascript:tiannetClear();" style="' + s_tiannet_link + '">清空</a>' +
