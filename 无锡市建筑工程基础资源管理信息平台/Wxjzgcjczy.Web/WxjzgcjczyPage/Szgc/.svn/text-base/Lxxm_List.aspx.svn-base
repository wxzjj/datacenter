<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Lxxm_List.aspx.cs" Inherits="Wxjzgcjczy.Web.WxjzgcjczyPage.Szgc.Lxxm_List" %>
...
<body style="background-color: #EEEEEE;">
    ...
    <table cellspacing="1" width="100%" align="center" border="0" class="table-bk">
        ...
        <tr>
            ...
            <td width="35%" class="td-value">
                <input type="text" class="field s-text" name="lxwh" style="width: 200px" />
            </td>
            <%-- <td width="15%" class="td-text">
                立项时间
            </td>
            <td width="35%" class="td-value">
                 <input type="text" class="field" id="lxrq" name="lxrq"  style="width: 200px" op="equal" />
            </td>
        </tr>
        <tr>--%>
            <td class="td-text">
    ...
    <script type="text/javascript">
        ...
        $(function() {
            ...
            $("#lxrq").ligerDateEditor({ showTime: false, label: '', labelWidth: 100, labelAlign: 'left' });

            manager = $("#maingrid").ligerGrid({
                columns: [

               { display: '序号', name: 'ROWNUMBER___', align: 'center', type: "text", width: "9%" },
               { display: '项目名称', name: 'XMMC', align: 'left', type: "text", width: "25%",
                   render: function(item) {
                       if (item.XMMC != null && item.XMMC != "") {
                           return "<a target='_blank' href='LxxmToolBar.aspx?LoginID=<%=this.WorkUser.UserID %>&rowid=" + item.ROW_ID + "' style='color:#000066;text-decoration: none;' >" + item.XMMC + "</a>";
                       }
                   }
               },
                { display: '建设单位', name: 'JSDW', align: 'left', type: "text", width: "25%",
                    render: function(item) {
                ...
                //                { display: '投资类型', name: 'TZLX', align: 'center', type: 'text', width: "10%" },
//                  {display: '立项部门', name: 'LXBM', align: 'center', type: 'text', width: "20%" },
                { display: '立项文号', name: 'LXWH', align: 'center', type: 'text', width: "25%" },
                //                { display: '立项日期', name: 'LXRQ', align: 'center', type: 'text', width: "10%" },
                {display: '所属区', name: 'SSDQ', align: 'center', type: 'text', width: "15%" }
                ], width: '99.8%', pageSizeOptions: [5, 10, 15, 20], isScroll: getGridIsScroll(),
                url: 'List.ashx?fromwhere=Xmxx&xmlx=lxxm',
