<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LxxmToolBar.aspx.cs" Inherits="Wxjzgcjczy.Web.WxjzgcjczyPage.Szgc.LxxmToolBar" %>
        ...
        <table width="100%" style="" cellpadding="0" cellspacing="0">
            <tr>
                <td style="width: 100%; height: 100%;">
                    <table class="td_menu" style="width: 40%; height: 100%;" cellpadding="0" cellspacing="0">
                        <tr>
                            <td class="td_current">
                                <a link='Lxxm_View.aspx?rowid=<%=rowID %>&befrom=toolbar'>基本信息</a>
                            </td>
                            <td class="td_space">
                            </td>
                            <td class="td_other">
                                <a link='Lxxm_ViewList.aspx?rowid=<%=rowID %>&befrom=toolbar'>施工工程</a>
                            </td>
                        </tr>
                    </table>
                </td>
