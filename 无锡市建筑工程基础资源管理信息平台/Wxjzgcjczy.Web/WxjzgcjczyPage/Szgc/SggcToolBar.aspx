<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SggcToolBar.aspx.cs" Inherits="Wxjzgcjczy.Web.WxjzgcjczyPage.Szgc.SggcToolBar" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>查看施工工程信息</title>
...
<body style="padding: 3px; padding-bottom: 0; overflow-x: hidden">
    ...
    <div style="width: 70%; margin: auto; float: none;">
        <table width="100%" style="" cellpadding="0" cellspacing="0">
            <tr>
                <td style="width: 100%; height: 100%;">
                    <table class="td_menu" style="width: 80%; height: 100%;" cellpadding="0" cellspacing="0">
                        <tr>
                            <td class="td_current">
                                <a link='Gcxm_View.aspx?rowid=<%=rowID %>&befrom=toolbar'>基本信息</a>
                            </td>
                            <td class="td_space">
                            </td>
                            <td class="td_other">
                                <a link='Cjgf.aspx?rowid=<%=rowID %>&befrom=toolbar'>参建各方</a>
                            </td>
                            <td class="td_space">
                            </td>
                            <td class="td_other">
                                <a link='Ztbxx.aspx?rowid=<%=rowID %>&befrom=toolbar'>招投标信息</a>
                            </td>
                            <td class="td_space">
                            </td>
                            <td class="td_other">
                                <a link='Htba_View.aspx?rowid=<%=rowID %>&befrom=toolbar'>合同备案</a>
                            </td>
                            <td class="td_space">
                            </td>
                            <td class="td_other">
                                <a link='Aqjd_View.aspx?rowid=<%=rowID %>&befrom=toolbar'>安全监督</a>
                            </td>
                            <td class="td_space">
                            </td>
                            <td class="td_other">
                                <a link='Gcxm_ZljdList.aspx?rowid=<%=rowID %>&befrom=toolbar'>质量监督</a>
                            </td>
                            <td class="td_space">
                            </td>
                            <td class="td_other">
                                <a link='Gcxm_SgxkList.aspx?rowid=<%=rowID %>&befrom=toolbar'>施工许可</a>
                            </td>
                            <td class="td_space">
                            </td>
                            <td class="td_other">
                                <a link='Gcxm_JgysList.aspx?rowid=<%=rowID %>&befrom=toolbar'>竣工验收</a>
                            </td>
                        </tr>
                    </table>
                </td>
