<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Tjfx_HtbaHtje.aspx.cs"
    Inherits="Wxjzgcjczy.Web.WxjzgcjczyPage.Report.Tjfx_HtbaHtje" %>
...
<body style="background-color: #EEEEEE;">
    ...
    <div style="padding: 2px 0px 0px 1px; text-align: center; background-color: White;">
        <asp:Chart ID="Chart1" runat="server" BorderDashStyle="Solid" Palette="BrightPastel"
            Height="330px" Width="980px" BackGradientStyle="TopBottom" BorderWidth="2" BackColor="WhiteSmoke"
