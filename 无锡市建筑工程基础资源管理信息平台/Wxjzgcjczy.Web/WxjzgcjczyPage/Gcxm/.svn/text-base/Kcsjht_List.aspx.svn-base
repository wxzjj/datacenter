<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Kcsjht_List.aspx.cs" Inherits="Wxjzgcjczy.Web.WxjzgcjczyPage.Gcxm.Kcsjht_List" %>
...
<body class="body_haveBackImg" style=" height:auto; overflow:auto;">
