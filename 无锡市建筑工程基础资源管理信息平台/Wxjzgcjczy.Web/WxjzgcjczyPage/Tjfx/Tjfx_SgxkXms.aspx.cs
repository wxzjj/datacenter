...
{
    public partial class Tjfx_SgxkXms : BasePage
    {
        private TjfxBLL BLL;
        ...
        private void searchData()
        {
            ...
            DataTable dt = BLL.RetrieveTjfx_SgxkTj_Count(BdateStart.SelectedValue, BdateEnd.SelectedValue, ssdq).Result;

            Chart1.ChartAreas["ChartArea1"].Area3DStyle.Enable3D = false;
            Chart1.Titles[0].Text = "年度施工许可证项目数量统计（单位：个）";
            Chart1.Series["Default"].LegendText = "施工许可证项目数量（个）";
            ...
            Chart1.Series["Default"].ToolTip = "#AXISLABEL的施工许可证项目数量为#VAL个";
            ...
            MakeParetoChart(Chart1, "Default", "Pareto", d_add, "施工许可证项目数量增幅(%)", Color.Orange);
