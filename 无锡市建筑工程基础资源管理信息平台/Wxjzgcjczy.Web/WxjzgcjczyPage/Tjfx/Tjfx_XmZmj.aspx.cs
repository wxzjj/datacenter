...
{
    public partial class Tjfx_XmZmj : BasePage
    {
        private TjfxBLL BLL;
        ...
        private void searchData()   
        {
            ...
            DataTable dt = BLL.RetrieveTjfx_XmTj_Zmj(ddl_Xmfl.SelectedValue, BdateStart.SelectedValue, BdateEnd.SelectedValue, ssdq).Result;

            Chart1.ChartAreas["ChartArea1"].Area3DStyle.Enable3D = false;
            Chart1.Titles[0].Text = "年度项目开工总面积统计（单位：平方米）";
            Chart1.Series["Default"].LegendText = "项目开工总面积（平方米）";
            ...
            Chart1.Series["Default"].ToolTip = "#AXISLABEL的项目开工总面积为#VAL平方米";
            ...
            MakeParetoChart(Chart1, "Default", "Pareto", d_add, "项目开工总面积增幅(%)", Color.Orange);
