...
{
    public partial class Tjfx_Xmsl_Jg : BasePage
    {
        private TjfxBLL BLL;
        ...
        private void searchData()
        {
            ...
            DataTable dt = BLL.RetrieveTjfx_XmTj_Count_Jg(ddl_Xmfl.SelectedValue, EdateStart.SelectedValue, EdateEnd.SelectedValue, ssdq).Result;

            Chart1.ChartAreas["ChartArea1"].Area3DStyle.Enable3D = false;
            Chart1.Titles[0].Text = "年度项目竣工数量统计（单位：个）";
            Chart1.Series["Default"].LegendText = "项目竣工数量（个）";
            ...
            Chart1.Series["Default"].ToolTip = "#AXISLABEL的项目竣工数量为#VAL个";
            ...
            MakeParetoChart(Chart1, "Default", "Pareto", d_add, "项目竣工数量增幅(%)", Color.Orange);       
