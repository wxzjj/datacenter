...
{
    public partial class Tjfx_XmZtz : BasePage
    {
        private TjfxBLL BLL;
        ...
        private void searchData()
        {
            ...
            DataTable dt = BLL.RetrieveTjfx_XmTj_Ztz( ddl_Xmfl.SelectedValue, BdateStart.SelectedValue, BdateEnd.SelectedValue, ssdq).Result;
            Chart1.ChartAreas["ChartArea1"].Area3DStyle.Enable3D = false;

            Chart1.Titles[0].Text = "年度项目总投资统计（单位：万元）";
            Chart1.Series["Default"].LegendText = "项目开工总投资（万元）";
            ...
            Chart1.Series["Default"].ToolTip = "#AXISLABEL的项目开工总投资为#VAL万元";
            ...
            MakeParetoChart(Chart1, "Default", "Pareto", d_add, "项目开工总投资增幅(%)", Color.Yellow);
