<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Tjfx_XmZmj_Jg.aspx.cs"
    Inherits="Wxjzgcjczy.Web.WxjzgcjczyPage.Tjfx.Tjfx_XmZmj_Jg" %>
...
<body style="background-color: #EEEEEE;">
    ...
    <table cellspacing="1" width="100%" align="center" border="0" class="table-bk">
        <tr>
            ...
            <td class="td-value">
                <Bigdesk8:DBDropDownList ID="EdateStart" runat="server" Width="100px">
                ...
                至
                <Bigdesk8:DBDropDownList ID="EdateEnd" runat="server" Width="100px">
                    <asp:ListItem></asp:ListItem>
                    <asp:ListItem>2010</asp:ListItem>
                    <asp:ListItem>2011</asp:ListItem>
                    <asp:ListItem>2012</asp:ListItem>
    ...
    <div style="padding: 2px 0px 0px 1px; text-align:center; background-color:White;">
        <asp:Chart ID="Chart1" runat="server" Height="330px" Width="980px" BorderDashStyle="Solid"
