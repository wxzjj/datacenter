<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Qyjjry_List.aspx.cs" Inherits="Wxjzgcjczy.Web.WxjzgcjczyPage.Zyry.Qyjjry_List" %>

<%@ Register Assembly="Bigdesk8" Namespace="Bigdesk8.Web.Controls" TagPrefix="Bigdesk8" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>企业技经人员信息列表</title>
...
<body style="background-color: #EEEEEE;">
    ...
    <table cellspacing="1" width="100%" align="center" border="0" class="table-bk">
        ...
        <tr>
            ...
            <td class="td-value" id="Td2">
                <select class="field s-text" name="CountyID" op="equal" style="width: 200px;">
                </select>
            </td>
            <td class="td-text">
                是否安监实名认证
        ...
        <tr>
            ...
            <td class="td-value" colspan="3">
                <input name="aa" id="jsry" type="checkbox" value="71" />技术人员&nbsp;&nbsp;
                <input name="aa" id="jjry" type="checkbox" value="72" />经济人员&nbsp;&nbsp; 
    ...
    <script type="text/javascript">
        ...
        $(function() {
            ...
            $("#Td2,#IsRefuse").ligerForm({
                toJSON: JSON2.stringify
            });
            if (rylx != null && rylx != '') {
                switch (rylx) {
                    case "jsry":
                        $("input[id='jsry']").attr("checked", "checked");
                        $("input[name='ryzyzglxID']").val("71");
                        break;
                    case "jjry":
                        $("input[id='jjry']").attr("checked", "checked");
                        $("input[name='ryzyzglxID']").val("72");
                        break;
            ...
            manager = $("#maingrid").ligerGrid({
               ...
               render: function(item) {
                   if (item.xm != null && item.xm != "") {
                       return "<a target='_blank' href='RyxxToolBar.aspx?ryid=" + item.ryid + "&rylx=qyjjry' style='color:#000066;text-decoration: none;' >" + item.xm + "</a>";
                   }
               }
           },
...
//                { display: '职称级别', name: 'zcjb', align: 'center', type: 'text', width: "8%" },
                ...
                { display: '所属企业', name: 'qymc', align: 'left', type: "text", width: "24%",
                    render: function(item) {
                ...
                url: 'List.ashx?fromwhere=Ryxx&rylx=qyjjry',
