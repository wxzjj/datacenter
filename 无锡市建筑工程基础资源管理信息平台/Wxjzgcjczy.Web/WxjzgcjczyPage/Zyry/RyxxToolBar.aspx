<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RyxxToolBar.aspx.cs" Inherits="Wxjzgcjczy.Web.WxjzgcjczyPage.Zyry.RyxxToolBar" %>
            ...
            <tr>
                <td style="width: 100%; height: 100%;">
                    <table class="td_menu" style="width: 70%; height: 100%;" cellpadding="0" cellspacing="0">
                        <tr>
                            <td class="td_current">
                                <a link='Ryxx_View.aspx?ryid=<%=ryID %>&befrom=toolbar&rylx=<%=rylx %>'>基本信息</a>
                            </td>
                            <td class="td_space">
                            </td>
                            <td class="td_other">
                                <a link='Zyzg.aspx?ryid=<%=ryID %>&befrom=toolbar&rylx=<%=rylx %>'>执业资格</a>
                            </td>
                            <td class="td_space">
                            </td>
                            <td class="td_other">
                                <a link='Cjxm.aspx?ryid=<%=ryID %>&befrom=toolbar&rylx=<%=rylx %>'>承揽工程</a>
                            </td>
                        </tr>
                    </table>
                </td>
