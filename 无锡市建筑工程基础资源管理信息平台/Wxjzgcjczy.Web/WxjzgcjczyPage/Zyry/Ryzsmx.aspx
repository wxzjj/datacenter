<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Ryzsmx.aspx.cs" Inherits="Wxjzgcjczy.Web.WxjzgcjczyPage.Zyry.Ryzsmx" %>
                ...
                <table cellspacing="1" cellpadding="0" width="100%" align="center" border="0" class="table-bk">
                    <tr>
                        ...
                        <td class="td-value" width="35%">
                            <Bigdesk8:DBText ID="DBText33" runat="server" ItemName="ryzyzglx">
                            </Bigdesk8:DBText>
                        </td>
                        <td class="td-text" width="15%">
                            证书类型
                        ...
                        <td class="td-value" width="35%">
                            <Bigdesk8:DBText ID="DBText34" runat="server" ItemName="ryzslx">
                            </Bigdesk8:DBText>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="td-value" width="35%">
                            <Bigdesk8:DBText ID="DBText1" runat="server" ItemName="sfzzz">
                            </Bigdesk8:DBText>
                        </td>
                        <td class="td-text" width="15%">
                            证书编号
                        ...
                        <td class="td-value" width="35%">
                            <Bigdesk8:DBText ID="DBText2" runat="server" ItemName="zsbh">
                            </Bigdesk8:DBText>
                        </td>
                    </tr>
                    <tr>
