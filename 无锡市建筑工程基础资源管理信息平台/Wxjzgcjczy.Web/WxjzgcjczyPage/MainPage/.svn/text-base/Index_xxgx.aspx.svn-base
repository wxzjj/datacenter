<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index_xxgx.aspx.cs" Inherits="Wxjzgcjczy.Web.WxjzgcjczyPage.MainPage.Index_xxgx" %>
...
<body style="background-color: #4364A9; padding: 0;" onload="leftclick('xxgx_csjk','left_icon_xxgx_csjk');">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="padding: 0px 0px 0px 0px;">
        <tr>
                ...
                <div id="leftmenu" style="position: absolute; top: 0px;">
                    <table border="0" cellspacing="0" cellpadding="0" width="150">
                        <tr>
                            ...
                            <td id="left_icon_xxgx_csjk" class="left_icon_leave" onmousemove="leftover(this.id);" onmouseout="leftout(this.id);"
                                onclick="leftclick('xxgx_csjk',this.id);">
                                <table >
                                    <tr>
                                        <td  class="tdImg">
            ...
            <td id="ItemTd" bgcolor="#EEEEEE" style="padding-left: 3px; padding-top: 0; padding-bottom: 0;
                padding-right: 0;">
                <iframe id="ItemIf" width="100%" style="padding: 0;" scrolling="auto" frameborder="0">
                </iframe>
            </td>
