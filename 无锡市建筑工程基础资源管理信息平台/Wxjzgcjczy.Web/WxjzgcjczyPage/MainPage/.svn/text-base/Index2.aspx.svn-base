<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index2.aspx.cs" Inherits="Wxjzgcjczy.Web.WxjzgcjczyPage.MainPage.Index2" %>
...
<body style="background-color: #4364A9; padding: 0; margin: 0;"  >
    ...
    <div style="height: 100%; margin-top: 0; margin-bottom: 0; padding: 0; margin-left: 4px;
        margin-right: 4px;">
        <iframe id="MainIf" width="100%" height="100%" scrolling="no" frameborder="0" marginheight="0"
    ...
    <div id="bottom" style="height: 25px; line-height: 25px; color: Black; font-size: 13px;
        ...
        &nbsp;&nbsp;&nbsp; &nbsp;&nbsp; <a id="loginOut" href="javascript:void(0)" style="color: Blue;
            text-decoration: none; font-family: 宋体;">注销</a> &nbsp; <a href="../Login2.htm" style="color: Blue;
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        var splitHtml = "<td width=\"1\"><img src=\"../Common/images/FrameImages/top_line.png\" width=\"1\" height=\"100\" style=\"padding:0;\" /></td>";
       
        if (hasXxcj == "1") {
            var html = "<td width=\"100\" id=\"top_icon_xxcj\" class=\"top_icon_xxcj_0\" onmousemove=\"tdover(this.id);\" onmouseout=\"tdout(this.id);\" onclick=\"Loading('xxcj',this.id,this.id);\"  style=\"padding:0;\" ></td>";
            $("#menu_tr").append(html);
            $("#menu_tr").append(splitHtml);
        }

        var html = "<td width=\"100\" id=\"top_icon_1\" class=\"top_icon_1_0\" onmousemove=\"tdover(this.id);\" onmouseout=\"tdout(this.id);\" onclick=\"Loading('10000000',this.id,this.id);\"  style=\"padding:0;\" ></td>";
        $("#menu_tr").append(html);
        $("#menu_tr").append(splitHtml);
        ...
        if ($("#menu").width() <= $("#menuSpace").width()) {

            $("#RightMove").hide();
            $("#LeftMove").hide();
            $("#menuSpace").width(width - $("#td_systemTitle").width());
        ...
        window.onload = function() {
            //Loading('xxcj', "top_icon_xxcj", "top_icon_xxcj");

        $("#menu_tr").find("td[class^=top_icon]").eq(0).trigger("click");
