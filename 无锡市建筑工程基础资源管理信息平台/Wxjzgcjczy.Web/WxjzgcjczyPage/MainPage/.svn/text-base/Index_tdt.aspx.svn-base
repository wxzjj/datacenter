<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index_tdt.aspx.cs" Inherits="Wxjzgcjczy.Web.WxjzgcjczyPage.MainPage.Index_tdt" %>
...
<body style="background-color: #4364A9; padding: 0;" onload="leftclick('tdt_1','left_icon_tdt_1');">
                ...
                <div id="leftmenu" style="position: absolute; top: 0px;">
                    <table border="0" cellspacing="0" cellpadding="0" width="150">
                        <tr>
                            ...
                            <td id="left_icon_tdt_1" class="left_icon_leave" onmousemove="leftover(this.id);" onmouseout="leftout(this.id);"
                                onclick="leftclick('tdt_1',this.id);">
                                <table >
                                    <tr>
                                        <td  class="tdImg">
                        ...
                        <tr>
                            ...
                            <tr>
                            <td id="left_icon_tdt_2" class="left_icon_leave" onmousemove="leftover(this.id);" onmouseout="leftout(this.id);"
                                onclick="leftclick('tdt_2',this.id);">
                                <table >
                                    <tr>
                                        <td  class="tdImg">
                                            <img src="../Common/images/FrameImages/02_01_0.png" />
