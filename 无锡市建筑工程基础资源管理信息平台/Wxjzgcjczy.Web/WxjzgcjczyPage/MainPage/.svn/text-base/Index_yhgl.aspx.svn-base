<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index_yhgl.aspx.cs" Inherits="Wxjzgcjczy.Web.WxjzgcjczyPage.MainPage.Index_yhgl" %>
...
<body style="background-color: #4364A9; padding: 0;" onload="leftclick('yhgl_1','left_icon_yhgl_1');">
                ...
                <div id="leftmenu" style="position: absolute; top: 0px;">
                    <table border="0" cellspacing="0" cellpadding="0" width="150">
                        <tr>
                            ...
                            <td id="left_icon_yhgl_1" class="left_icon_leave" onmousemove="leftover(this.id);" onmouseout="leftout(this.id);"
                                onclick="leftclick('yhgl_1',this.id);">
                                <table >
                                    <tr>
                                        <td  class="tdImg">
