<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Zjgyxm_List.aspx.cs" Inherits="Wxjzgcjczy.Web.WxjzgcjczyPage.Gzyj.Zjgyxm_List" %>

<%@ Register Assembly="Bigdesk8" Namespace="Bigdesk8.Web.Controls" TagPrefix="Bigdesk8" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>造价过亿项目列表</title>
        ...
        $(function() {
            ...
            manager = $("#maingrid").ligerGrid({
               ...
               render: function(item) {
                ...
                }, { display: '所属区', name: 'County', align: 'center', type: 'text', width: "20%" },
                ...
                //                      }
                //                  },
                     {display: '总面积(平方米)', name: 'AllArea', align: 'center', type: 'text', width: "15%" },
                { display: '总投资(万元)', name: 'AllInvest', align: 'center', type: 'text', width: "15%" }
                 ], width: '99.8%', pageSizeOptions: [5, 10, 15, 20], isScroll: getGridIsScroll(),
                url: 'List.ashx?fromwhere=zjgyxm',
