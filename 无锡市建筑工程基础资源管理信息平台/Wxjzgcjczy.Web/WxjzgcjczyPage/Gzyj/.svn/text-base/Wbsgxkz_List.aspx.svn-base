<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Wbsgxkz_List.aspx.cs" Inherits="Wxjzgcjczy.Web.WxjzgcjczyPage.Gzyj.Wbsgxkz_List" %>

<%@ Register Assembly="Bigdesk8" Namespace="Bigdesk8.Web.Controls" TagPrefix="Bigdesk8" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>未办施工许可证项目</title>
        ...
        $(function() {
            ...
            manager = $("#maingrid").ligerGrid({
               ...
               { display: '项目名称', name: 'PrjName', align: 'left', type: "text", width: "25%",
                ...
                url: 'List.ashx?fromwhere=wbsgxkz',
