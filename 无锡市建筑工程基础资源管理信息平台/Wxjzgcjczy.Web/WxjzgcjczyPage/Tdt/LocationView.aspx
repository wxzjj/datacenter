                    ...
                    if (result) {
                        ...
                        for (var i = 0; i < markerArr.length; i++) {
                            ...
                            (function(i) {
                                ...
                                var name = json.title;
                                var winHtml = "<span class=\"info_label\">项目编码：</span>" + json.prjNum + "<br/><span class=\"info_label\">项目名称：</span>" + json.xmmc + "<br/><span class=\"info_label\">建设单位：</span>" + json.jsdw + "<br /><span class=\"info_label\">施工总包单位：</span>" + json.sgdw + "<br/><span class=\"info_label\">勘察单位：</span>" + "<br/><span class=\"info_label\">设计单位：</span>" + "<br/><span class=\"info_label\">监理单位：</span>" + json.jldw
                                + "<br/><span class=\"info_label\">开工日期：</span>" + json.kgrq + "<br/><span class=\"info_label\">建设规模：</span>" + json.jsgm + "<br/><span class=\"info_label\">项目总投资：</span>" + json.xmztz + "<br/><span class=\"info_label\">是否手工标注：</span>" + (json.isSgbz == 1 ? "是" : "否");
                                TEvent.bind(
                    ...
                    if (result) {
                        ...
                        for (var i = 0; i < markerArr.length; i++) {
                            ...
                            (function(i) {
                                ...
                                var name = json.title;
                                var winHtml = "<span class=\"info_label\">项目编码：</span>" + json.prjNum + "<br/><span class=\"info_label\">项目名称：</span>" + json.xmmc + "<br/><span class=\"info_label\">建设单位：</span>" + json.jsdw + "<br /><span class=\"info_label\">施工总包单位：</span>" + json.sgdw + "<br/><span class=\"info_label\">勘察单位：</span>" + "<br/><span class=\"info_label\">设计单位：</span>" + "<br/><span class=\"info_label\">监理单位：</span>" + json.jldw
                                + "<br/><span class=\"info_label\">开工日期：</span>" + json.kgrq + "<br/><span class=\"info_label\">建设规模：</span>" + json.jsgm + "<br/><span class=\"info_label\">项目总投资：</span>" + json.xmztz + "<span class=\"info_label\">是否手工标注：</span>" + json.isSgbz == 1 ? "是" : "否";
                                TEvent.bind(
          marker, "click", marker, function() {
              var info = this.openInfoWinHtml(winHtml);
              info.setTitle(name);
...
<body  style="margin: 0; padding: 0;">
    ...
    <div id="searchbox" style="border: 0; vertical-align: middle; font-size: 14px; font-family: 宋体;
        ...
        <input name="xmdjrq" type="text" value="" style="font-size: 14px; font-family: 宋体;
    ...
    <div id="mapDiv" style="position: absolute; width: 100%; height: 457px; margin-top: 3px;"
        align="left">
    </div>
