<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Qtdw_List.aspx.cs" Inherits="Wxjzgcjczy.Web.WxjzgcjczyPage.Szqy.Qtdw_List" %>
    ...
    <script type="text/javascript">
        ...
        $.ajax({
            ...
            manager = $("#maingrid").ligerGrid({
               ...
               {display: '单位名称', name: 'qymc', align: 'left', type: "text", width: "22%",
               render: function(item) {
                 ...
                 { display: '组织机构代码(社会信用代码)', name: 'zzjgdm', align: 'center', type: "text", width: "14%" },
                { display: '单位地址', name: 'xxdd', align: 'left', type: "text", width: "28%" },
                   { display: '营业执照注册号', name: 'yyzzzch', align: 'center', type: 'text', width: "13%" },
                { display: '企业联系电话', name: 'lxdh', align: 'center', type: 'text', width: "14%" },
                ...
                url: 'List.ashx?fromwhere=Qyxx&qylx=qtdw',
