<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sjdw_List.aspx.cs" Inherits="Wxjzgcjczy.Web.WxjzgcjczyPage.Szqy.Sjdw_List" %>
        ...
        $(function() {
          ...
          $.ajax({
            ...
            manager = $("#maingrid").ligerGrid({
               ...
               {display: '单位名称', align: 'left', type: "text", width: "21%",
               render: function(item) {
                   if (item.qymc != null && item.qymc != "") {
                       return "<a target='_blank' href='QyxxToolBar.aspx?LoginID=<%=this.WorkUser.UserID %>&qyid=" + item.qyid + "&befrom=sjdw' style='color:#000066;text-decoration: none;' >" + item.qymc + "</a>";
                   }
               }
           },
             { display: '组织机构代码(社会信用代码)', name: 'zzjgdm', align: 'center', type: "text", width: "13%" },
                { display: '单位地址', name: 'xxdd', align: 'left', type: "text", width: "24%" },
