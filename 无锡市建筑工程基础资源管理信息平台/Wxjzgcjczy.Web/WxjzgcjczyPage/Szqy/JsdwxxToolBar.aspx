<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JsdwxxToolBar.aspx.cs"
    Inherits="Wxjzgcjczy.Web.WxjzgcjczyPage.Szqy.JsdwxxToolBar" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>查看建设单位信息</title>
            ...
            <tr>
                <td style="width: 100%; height: 100%;">
                    <table class="td_menu" style="width: 40%; height: 100%;" cellpadding="0" cellspacing="0">
                        <tr>
                            <td class="td_current">
                                <a link='Jsdw_View.aspx?jsdwid=<%=jsdwid %>&befrom=toolbar'>基本信息</a>
                            </td>
                            <td class="td_space">
                            </td>
                           <%-- <td class="td_other">
                                <a link='Jsdwzz.aspx?rowid=<%=rowID %>&befrom=toolbar'>资质信息</a>
                            </td>
                             <td class="td_space">
                            </td>--%>
                            <td class="td_other">
                                <a link='Jsdwssgc.aspx?jsdwid=<%=jsdwid %>&befrom=toolbar'>所属工程</a>
                            </td>
                        </tr>
                    </table>
                </td>
