...
//       var url=document.location.href.split('/')[6];
//       if (url) this.setText(addHTMLTag(url));
//      } else {
//        var defaultText = element.getAttribute("data-clipboard-text");
//        if (defaultText) this.setText(addHTMLTag(defaultText));
//      }
     {
 ...
 function addHTMLTag(str){
	 ...
	 //删除编码格式，让其自动匹配
	 re=re.replace(/\r/g,'');
	 re=re.replace("<meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\"/>\n","");
     return re;
 }