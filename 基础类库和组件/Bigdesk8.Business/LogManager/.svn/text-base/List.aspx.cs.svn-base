...
namespace Bigdesk8.Business.LogManager
{
    ...
    {
        private readonly ILogManager logger = LogManagerFactory.CreateLogManager("");
        ...
        private void searchData(int pageIndex)
        {
            ...
            int allRecordCount;
            List<BusinessLog> logs = logger.GetLog(list, this.gridView.PageSize, pageIndex, out allRecordCount);
