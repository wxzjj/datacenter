<%@ Page Title="系统日志" Language="C#" MasterPageFile="../BusinessSite.Master" AutoEventWireup="true"
    CodeBehind="List.aspx.cs" Inherits="Bigdesk8.Business.LogManager.List" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Master_Content" runat="server">
    ...
    <table cellspacing="5" cellpadding="0" width="100%" border="0">
        <tr>
            <td>
                您的位置：<span style="color: Blue">系统日志</span>
            </td>
        </tr>
        <tr>
            ...
            <td style="background: #666">
                <table width="100%" border="0" cellspacing="1" cellpadding="5">
                    ...
                    <tr>
                        ...
                        <td style="background: #fff; width: 35%; height: 30px">
                            <Bigdesk8:DBTextBox ID="DBTextBox22" runat="server" ItemName="Operation" />
                        </td>
                    </tr>
                    <tr>
                        <td style="background: #fff; height: 30px; width: 15%; text-align: center">
                        ...
                        <td style="background: #fff; width: 35%; height: 30px">
                            <Bigdesk8:DBTextBox ID="DBTextBox4" runat="server" ItemName="OperatorName" />
                        </td>
                        <td style="background: #fff; height: 30px; width: 15%; text-align: center">
                            操作日期
                        </td>
                        <td style="background: #fff; width: 35%; height: 30px">
                            <Bigdesk8:DBDatePicker ID="dp_begin" runat="server" ItemRelation="GreaterThanOrEqual"
                                Width="75px" ItemName="OperateDateTime" ItemNameCN="操作日期" />
                            至
            ...
            <td>
                <Bigdesk8:PowerDataGrid ID="gridView" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Operation" HeaderText="操作" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Center" />
                        <asp:BoundField DataField="MessageInfo" HeaderText="操作信息" ItemStyle-Width="10%" />
                        <asp:BoundField DataField="OperatorName" HeaderText="操作人名称" ItemStyle-Width="10%"
                            ItemStyle-HorizontalAlign="Center" />
                        <asp:BoundField HeaderText="操作时间" ItemStyle-Width="8%" ItemStyle-HorizontalAlign="Center"
                            DataFormatString="{0:yyyy-MM-dd HH:mm:ss}" DataField="OperateDateTime" />
                        <asp:HyperLinkField HeaderText="查看" ItemStyle-Width="4%" ItemStyle-HorizontalAlign="Center"
                            HeaderStyle-ForeColor="Yellow" Text="查看" DataNavigateUrlFields="LogID" DataNavigateUrlFormatString="View.aspx?ID={0}"
                            Target="_blank" />
                    </Columns>
