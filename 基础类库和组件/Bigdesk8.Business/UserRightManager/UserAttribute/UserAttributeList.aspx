<%@ Page Title="用户特性" Language="C#" MasterPageFile="../../BusinessSite.Master" AutoEventWireup="true"
    CodeBehind="UserAttributeList.aspx.cs" Inherits="Bigdesk8.Business.UserRightManager.UserAttribute.UserAttributeList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Master_Content" runat="server">
    ...
    <table cellspacing="5" cellpadding="0" width="100%" border="0">
        <tr>
            <td>
                您的位置：<span style="color: Blue">用户特性</span>
            </td>
        </tr>
        <tr>
            ...
            <td style="background: #666">
                <table width="100%" border="0" cellspacing="1" cellpadding="5">
                    ...
                    <tr>
                        ...
                        <td style="background: #fff; width: 35%; height: 30px">
                            <Bigdesk8:DBTextBox ID="DBTextBox4" runat="server" ItemName="AttributeValue" />
                        </td>
                    </tr>
                </table>
            </td>
            ...
            <td>
                <Bigdesk8:PowerDataGrid ID="gridView" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="AttributeValue" HeaderText="特性值" ItemStyle-Width="15%"
                            ItemStyle-HorizontalAlign="Center" />
                    </Columns>
