<%@ Page Title="修改特性信息" Language="C#" MasterPageFile="../../BusinessSite.Master"
    AutoEventWireup="true" CodeBehind="AttributeModify.aspx.cs" Inherits="Bigdesk8.Business.UserRightManager.UserAttribute.AttributeModify" %>
        ...
        <tr>
            <td>
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td>
                            您的位置：<span style="color: Blue">特性管理 - 修改特性信息</span>
                        </td>
                        <td align="right">
