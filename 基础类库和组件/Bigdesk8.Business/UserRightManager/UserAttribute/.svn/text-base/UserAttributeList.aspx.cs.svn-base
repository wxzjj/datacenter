...
{
    public partial class UserAttributeList : SystemBasePage
    {
        ...
        private void searchData(int pageIndex)
        {
            ...
            int allRecordCount;
            DataTable dt = userManager.SearchUserAttribute(list, this.gridView.PageSize, pageIndex, out allRecordCount);
