...
{
    public partial class UserList : SystemBasePage
    {
        ...
        {
            int userID = ((Label)this.gridView.Rows[e.RowIndex].FindControl("lbl_UserID")).Text.ToInt32();
        ...
        private void searchData(int pageIndex)
        {
            ...
            int allRecordCount;
            DataTable dt = userManager.SearchUser(list, this.gridView.PageSize, pageIndex, out allRecordCount);
