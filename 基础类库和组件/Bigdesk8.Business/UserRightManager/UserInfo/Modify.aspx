<%@ Page Title="修改用户信息" Language="C#" MasterPageFile="../../BusinessSite.Master"
    AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="Bigdesk8.Business.UserRightManager.UserInfo.Modify" %>
        ...
        <tr>
            <td>
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td>
                            您的位置：<span style="color: Blue">用户管理 - 修改用户信息</span>
                        </td>
                        <td align="right">
                            <a href="UserList.aspx" title="返回">
            ...
            <td style="background: #666">
                <table width="100%" border="0" cellspacing="1" cellpadding="5">
                    <tr>
                        ...
                        <td style="background: #fff; height: 30px; width: 35%">
                            <Bigdesk8:DBTextBox ID="DBTextBox1" runat="server" ItemName="LoginPassword" ItemIsRequired="True"
                                ItemNameCN="登录密码" ItemDefaultData="123456"></Bigdesk8:DBTextBox>
                        </td>
                    </tr>
                    <tr>
                        <td style="background: #fff; height: 30px; width: 15%; text-align: center; color: Red">
                        ...
                        <td style="background: #fff; height: 30px; width: 35%">
                            <Bigdesk8:DBTextBox ID="DBTextBox18" runat="server" ItemName="UserName" ItemIsRequired="true"
                                ItemNameCN="用户名称"></Bigdesk8:DBTextBox>
                        </td>
                        <td style="background: #fff; height: 30px; width: 15%; text-align: center">
                        </td>
                        <td style="background: #fff; height: 30px; width: 35%">
