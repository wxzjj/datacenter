<%@ Page Title="选择用户" Language="C#" MasterPageFile="../../BusinessSite.Master" AutoEventWireup="true"
    CodeBehind="UserList.aspx.cs" Inherits="Bigdesk8.Business.UserRightManager.UserRole.UserList" %>
        ...
        <tr>
            <td>
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td>
                            您的位置：<span style="color: Blue">用户角色 - 维护 - 选择用户</span>
                        </td>
                        <td align="right">
            ...
            <td>
                <Bigdesk8:PowerDataGrid ID="gridView" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:HyperLinkField HeaderText="设置角色" ItemStyle-Width="8%" ItemStyle-HorizontalAlign="Center"
                            HeaderStyle-ForeColor="Yellow" Text="设置角色" DataNavigateUrlFields="UserID" DataNavigateUrlFormatString="SetUserRole.aspx?UserID={0}" />
                    </Columns>
