<%@ Page Title="修改角色信息" Language="C#" MasterPageFile="../../BusinessSite.Master"
    AutoEventWireup="true" CodeBehind="RoleModify.aspx.cs" Inherits="Bigdesk8.Business.UserRightManager.UserRole.RoleModify" %>
        ...
        <tr>
            <td>
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td>
                            您的位置：<span style="color: Blue">角色管理 - 修改角色信息</span>
                        </td>
                        <td align="right">
                            <a href="RoleList.aspx" title="返回">
                ...
                <table width="100%" border="0" cellspacing="1" cellpadding="5">
                    <tr>
                        ...
                        <td style="background: #fff; height: 30px; width: 35%">
                            <Bigdesk8:DBTextBox ID="DBTextBox17" runat="server" ItemName="RoleName" ItemIsRequired="True"
                                ItemNameCN="角色名称"></Bigdesk8:DBTextBox>
                        </td>
                        <td style="background: #fff; height: 30px; width: 15%; text-align: center">
                            角色描述
                        </td>
                        <td style="background: #fff; height: 30px; width: 35%">
                            <Bigdesk8:DBTextBox ID="DBTextBox1" runat="server" ItemName="RoleDesc" ItemNameCN="角色描述"></Bigdesk8:DBTextBox>
                        </td>
                    </tr>
                    <tr>
                        <td style="background: #fff; height: 30px; width: 15%; text-align: center; color: Red">
