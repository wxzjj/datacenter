<%@ Page Title="新增角色" Language="C#" MasterPageFile="../../BusinessSite.Master" AutoEventWireup="true"
    CodeBehind="RoleCreate.aspx.cs" Inherits="Bigdesk8.Business.UserRightManager.UserRole.RoleCreate" %>
        ...
        <tr>
            <td>
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td>
                            您的位置：<span style="color: Blue">角色管理 - 新增角色</span>
                        </td>
                        <td align="right">
