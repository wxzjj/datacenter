...
namespace Bigdesk8.Business.DebugManager
{
    ...
    {
        private readonly IDebugManager debugger = DebugManagerFactory.CreateDebugManager("");
        ...
        private void searchData(int pageIndex)
        {
            ...
            int allRecordCount;
            List<BusinessDebug> debugs = debugger.GetDebug(list, this.gridView.PageSize, pageIndex, out allRecordCount);

            this.gridView.RecordCount = allRecordCount;
            this.gridView.PageIndex = pageIndex;
            this.gridView.DataSource = debugs;
