...
namespace Bigdesk8.Web
{
    ...
    {
        private const string KeyNameOfLoginID = "UniLoginID";
        ...
        public static ResultOfInitScicLogin InitScicLogin(DBOperator dbOperator, int userID)
        {
            ...
            Bigdesk8.Business.UserRightManager.IUserRightInfo ur = new Bigdesk8.Business.UserRightManager.UserRightInfo(dbOperator, userID);
        ...
        public static BasicLoginInfo GetBasicLoginInfo()
        {
            ...
            else if (!HttpContext.Current.Session[SessionNameOfBasicLoginInfo].IsEmpty()) //如果没有用cookie,则从session中查找
            {
