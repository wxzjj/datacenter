...
namespace Bigdesk8.Web.Controls
{
    ...
    public class PowerDataPager : WebControl, INamingContainer
    {
        ...
        private Control CreateFirstLastNextPrevPager()
        {
            ...
            {
                /*
                 * 如果定义了pager的对齐方式，则认为是将页数显示和翻页功能两个单元格当作一个整体（即一个单元格），按照对齐方式对齐
                 * 2015-04-19  吴奎
                 */
                case HorizontalAlign.Left:
                case HorizontalAlign.Right:
                case HorizontalAlign.Center:
                    TableCell row1cell = new TableCell();
                    row1cell.HorizontalAlign = this.PagerStyle.HorizontalAlign;
                    row1cell.BorderWidth = 0;
                    row1cell.BackColor = this.PagerStyle.BackColor;
                    row1cell.ForeColor = this.PagerStyle.ForeColor;

                    row1cell.Controls.Add(new LiteralControl(string.Format(PageString, this.PagedData.CurrentPageIndex + 1, this.PagedData.PageCount, this.PagedData.RecordCount)));

                    row1cell.Controls.Add(new LiteralControl("&nbsp;&nbsp;"));
                    row1cell.Controls.Add(firstControl);
                    row1cell.Controls.Add(new LiteralControl("&nbsp;&nbsp;"));
                    row1cell.Controls.Add(prevControl);
                    row1cell.Controls.Add(new LiteralControl("&nbsp;&nbsp;"));
                    row1cell.Controls.Add(nextControl);
                    row1cell.Controls.Add(new LiteralControl("&nbsp;&nbsp;"));
                    row1cell.Controls.Add(lastControl);
                    row1cell.Controls.Add(new LiteralControl("&nbsp;&nbsp;"));
                    row1cell.Controls.Add(new LiteralControl("转到："));
                    row1cell.Controls.Add(pageIndexControl);
                    row1cell.Controls.Add(new LiteralControl("页"));

                    row.Cells.Add(row1cell);

                    table.Rows.Add(row);
                    break;
                /*
                 * 如果没定义pager的对齐方式，则认为是页数显示和翻页功能是两个单元格，并各自左右对齐
                 * 2015-04-19  吴奎
                 */
                default:
