...
namespace Bigdesk8.Security
{
    ...
    public class AntiSqlInjection
    {
        ...
        {
            if (sqlString.IsEmpty()) return sqlString;
        ...
        public static string GetSafeInput(string inputString)
        {
            ...
            if (localString.IndexOf("char(") > 0)
                throw new Exception("用户输入“" + inputString + "”中含有非法的char(！");
        ...
        public static string ParameterizeInClause(string inClause, string preOfParam, ref SqlParameterCollection sp)
        {
