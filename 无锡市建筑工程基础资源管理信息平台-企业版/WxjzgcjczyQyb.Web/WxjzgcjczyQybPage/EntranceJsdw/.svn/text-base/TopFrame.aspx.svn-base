<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TopFrame.aspx.cs" Inherits="WxjzgcjczyQyb.Web.WxjzgcjczyQybPage.EntranceJsdw.TopFrame" %>
    ...
    <div style="position: fixed; top: 15px; right: 20px; height: 100px; float: right;">
        <table align="right" style="width: 200px; text-align: center; color: white;" border="0"
            ...
            <tr style="height: 50px; vertical-align: bottom;">
                <td style="width: 55px;">
                    <a style="color: White;" href="##" onclick="home();">
            ...
            <tr style="height: 15px;">
                <td style="width: 55px;">
                    <a style="color: White;" href="##" onclick="home();">返回首页</a>
                </td>
                <td style="width: 10px;">
                </td>
                <td style="width: 55px;">
