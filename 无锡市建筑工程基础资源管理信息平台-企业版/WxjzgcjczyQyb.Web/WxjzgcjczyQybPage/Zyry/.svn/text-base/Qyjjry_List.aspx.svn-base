<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Qyjjry_List.aspx.cs" Inherits="WxjzgcjczyQyb.Web.WxjzgcjczyQybPage.Zyry.Qyjjry_List" %>
        ...
        <tr>
            <td class="searchpanel">
                <div class="searchtitle">
                    <span>您的当前位置：</span><span>执业人员>企业技经人员</span><img alt="" src="../../App_Themes/WxjzgcjczyQyb_B_Theme/images/icons/searchtool.gif" />
                    <%-- <div class="togglebtn">
                    </div>--%>
                </div>
                    ...
                    <tr>
                        ...
                        <td class="td-value" width="20%" colspan="3">
                            <Bigdesk8:DBCheckBoxList ID="DBCheckBoxList1" runat="server" RepeatDirection="Horizontal"
                                ForeColor="Black">
                                <asp:ListItem Value="71">技术人员</asp:ListItem>
                                <asp:ListItem Value="72">经济人员</asp:ListItem>
                ...
                <Bigdesk8:PowerDataGrid ID="gridView" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="姓名">
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperLink_View" runat="server" Text='<%#Eval("xm") %>' NavigateUrl='<%#string.Format("RyxxToolBar.aspx?ryid={0}&rylx=qyjjry",Eval("ryid")) %>'
                                    Target="_blank" />
                            </ItemTemplate>
