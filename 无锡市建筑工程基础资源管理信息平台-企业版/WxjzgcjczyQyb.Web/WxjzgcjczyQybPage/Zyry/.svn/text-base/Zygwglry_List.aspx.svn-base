<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Zygwglry_List.aspx.cs"
    Inherits="WxjzgcjczyQyb.Web.WxjzgcjczyQybPage.Zyry.Zygwglry_List" %>
        ...
        <tr>
            <td class="searchpanel">
                <div class="searchtitle">
                    <span>您的当前位置：</span><span>执业人员>专业岗位管理人员</span><img alt="" src="../../App_Themes/WxjzgcjczyQyb_B_Theme/images/icons/searchtool.gif" />
                    <%--<div class="togglebtn">
                    </div>--%>
                </div>
                    ...
                    <tr>
                        ...
                        <td class="td-value" width="20%" colspan="3">
                            <Bigdesk8:DBCheckBoxList ID="DBCheckBoxList1" runat="server" RepeatDirection="Horizontal"
                                ForeColor="Black">
                                <asp:ListItem Value="7">施工员</asp:ListItem>
                                <asp:ListItem Value="8">质量员</asp:ListItem>
                                <asp:ListItem Value="9">材料员</asp:ListItem>
                                <asp:ListItem Value="11">机械员</asp:ListItem>
                                <asp:ListItem Value="12">资料员</asp:ListItem>
                                <asp:ListItem Value="14">试验员</asp:ListItem>
                                <asp:ListItem Value="15">见证取样员</asp:ListItem>
                                <asp:ListItem Value="16">城建档案管理员</asp:ListItem>
                                <asp:ListItem Value="17">特种作业人员</asp:ListItem>
                                <asp:ListItem Value="18">技术工人</asp:ListItem>
                                <asp:ListItem Value="22">监理员</asp:ListItem>
                                <asp:ListItem Value="42">造价员</asp:ListItem>
                ...
                <Bigdesk8:PowerDataGrid ID="gridView" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="姓名">
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperLink_View" runat="server" Text='<%#Eval("xm") %>' NavigateUrl='<%#string.Format("RyxxToolBar.aspx?ryid={0}&rylx=zygwglry",Eval("ryid")) %>'
                                    Target="_blank" />
                            </ItemTemplate>
