...
{
    public partial class Zhjg_Aqbj_View : BasePage
    {
        public string PKID;
        public string aqjdbm;
        GcxmBLL gcxm;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            aqjdbm = Request.QueryString["aqjdbm"].ToString();
        ...
        {
            DataTable dt = gcxm.GetAqbjxxByPKID(PKID).Result;
            this.SetControlValue(dt.Rows[0].ToDataItem());

            DataTable dtdxxm = gcxm.GetAqbjxxByAqjdbm(aqjdbm).Result;
