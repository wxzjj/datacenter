...
{
    public partial class Zhjg_Zbtb_List : BasePage
    {
        ...
        public void SearData(int pageIndex)
        {
            ...
            //{
            //    WebCommon.AddDataItem(list, "TenderCorpCode", this.WorkUser.LoginName);
            //}
            ...
            if (bIsBeFrom)
            {
                ...
                dt = gcxmBll.GetZbtb(list, this.gridView.PageSize, "  TenderResultDate desc ", pageIndex, out allRecordCount).Result;
            }
            else
            {
                dt = gcxmBll.GetZbtb(list, this.gridView.PageSize, " TenderResultDate desc ", pageIndex, out allRecordCount).Result;
