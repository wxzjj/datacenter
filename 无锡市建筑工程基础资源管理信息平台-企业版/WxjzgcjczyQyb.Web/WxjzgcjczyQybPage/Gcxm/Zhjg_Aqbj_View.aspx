<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Zhjg_Aqbj_View.aspx.cs"
    Inherits="WxjzgcjczyQyb.Web.WxjzgcjczyQybPage.Gcxm.Zhjg_Aqbj_View" %>
...
<body>
    ...
    <table id="RwjbxxTab" cellspacing="0" cellpadding="1" width="100%" border="0">
        <tr>
            <td class="editpanel">
                <div class="edittitle">
                    报监工程基本信息<img alt="" src="../Common/images/clipboard.png" width="16" height="16" />
                        ...
                        <td class="td-value" colspan="3">
                            <asp:GridView ID="Gdv_SgxkCyryInfo" runat="server" AllowPaging="false" AutoGenerateColumns="false"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="组织机构代码（统一社会信用代码）" DataField="CorpCode">
                                        <HeaderStyle CssClass="pdg-headerstyle-center"></HeaderStyle>
                                        <ItemStyle CssClass="pdg-itemstyle-center" Width="2%"></ItemStyle>
                                    </asp:BoundField>
