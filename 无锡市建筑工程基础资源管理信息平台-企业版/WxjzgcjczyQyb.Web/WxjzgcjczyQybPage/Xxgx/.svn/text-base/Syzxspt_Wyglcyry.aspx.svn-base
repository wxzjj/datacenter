<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Syzxspt_Wyglcyry.aspx.cs"
    Inherits="WxjzgcjczyQyb.Web.WxjzgcjczyQybPage.Xxgx.Syzxspt_Wyglcyry" %>
            ...
            <td class="searchbox">
                <table width="100%" border="0" cellspacing="1" cellpadding="2" class="table-bk">
                    <tr>
                        ...
                        <td class="td-value" width="20%">
                            <Bigdesk8:DBDatePicker ID="DBDatePicker5" ItemName="ZSYXSJ" runat="server" ItemRelation="GreaterThanOrEqual"
                                Width="100px"> </Bigdesk8:DBDatePicker>
                            <Bigdesk8:DBDatePicker ID="DBDatePicker6" ItemName="ZSYXSJ" runat="server" ItemRelation="LessThanOrEqual"
                                Width="100px"> </Bigdesk8:DBDatePicker>
                        </td>
                    </tr>
                    <tr>
            ...
            <td class="maingrid">
                <Bigdesk8:PowerDataGrid ID="gridView" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderText="物岗证字号" DataField="WGZZH">
                            <HeaderStyle CssClass="pdg-headerstyle-center"></HeaderStyle>
                            <ItemStyle CssClass="pdg-itemstyle-center" Width="2%"></ItemStyle>
                        </asp:BoundField>
                        <asp:BoundField HeaderText="发证单位" DataField="FZDW">
                            <HeaderStyle CssClass="pdg-headerstyle-center"></HeaderStyle>
                        ...
                        <asp:BoundField HeaderText="证书有效时间" DataField="ZSYXSJ" DataFormatString="{0: yyyy-MM-dd}">
                            <HeaderStyle CssClass="pdg-headerstyle-center"></HeaderStyle>
                            <ItemStyle CssClass="pdg-itemstyle-center" Width="3%"></ItemStyle>
                        </asp:BoundField>
                        <asp:BoundField HeaderText="继续教育日期" DataField="JXJYRQ" DataFormatString="{0: yyyy-MM-dd}">
                            <HeaderStyle CssClass="pdg-headerstyle-center"></HeaderStyle>
                            <ItemStyle CssClass="pdg-itemstyle-center" Width="3%"></ItemStyle>
                        </asp:BoundField>
