<%@ Page Title="信息提示" Language="C#" AutoEventWireup="true" CodeBehind="Msg_Ryxx.aspx.cs"
    Inherits="WxjzgcjczyQyb.Web.WxjzgcjczyQybPage.Msg_Ryxx" %>
...
<head id="Head1" runat="server">
    <base target="_self" />
    <link href="../../App_Themes/WxjzgcjczyQyb_C_Theme/base.css" rel="stylesheet" type="text/css" />
                        ...
                        <td height="200">
                            <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                <tr>
                                    <td>
                                        <div align="center">
                                            <img height="128" src="Common/images/Help_ErrorMsg.jpg" width="128"></div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <table cellspacing="1" cellpadding="10" width="100%" border="0">
                                            <tr>
                                                <td>
                                                    对不起,您的个人信息尚未维护,请先维护您的个人信息（我的工作台-个人信息-我的信息）!
                                                </td>
                                            </tr>
                                            <%--  <tr>
                                                <td>
