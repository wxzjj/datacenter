<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LeftFrame.aspx.cs" Inherits="WxjzgcjczyQyb.Web.WxjzgcjczyQybPage.Entrance.LeftFrame" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html>
<head id="Head1" runat="server">
    <title>左侧框架-管理版</title>
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="width: 147px;">
            <tr class="menutitlebk">
                <td class="menutitleshow">
                    <img src="../../App_Themes/WxjzgcjczyQyb_B_Theme/images/icons/home.png" align="absmiddle"
                        height="16" width="16" />
                    系统菜单
                </td>
