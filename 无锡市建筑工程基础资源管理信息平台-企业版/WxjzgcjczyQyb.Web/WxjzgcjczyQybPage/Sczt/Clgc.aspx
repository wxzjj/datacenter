<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Clgc.aspx.cs" Inherits="WxjzgcjczyQyb.Web.WxjzgcjczyQybPage.Sczt.Clgc" %>
                ...
                <Bigdesk8:PowerDataGrid ID="gridView" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                       ...
                       <%-- <asp:BoundField HeaderText="合同金额(万元)" DataField="ContractMoney">
                        ...
                        <asp:BoundField HeaderText="合同签订日期" DataField="ContractDate" DataFormatString="{0:yyyy-MM-dd}">
                            <ItemStyle CssClass="pdg-itemstyle-center" Width="2%"></ItemStyle>
                            <HeaderStyle CssClass="pdg-headerstyle-center"></HeaderStyle>
                        </asp:BoundField>
                        <asp:BoundField HeaderText="项目总监" DataField="PrjHead">
                            <ItemStyle CssClass="pdg-itemstyle-center" Width="2%"></ItemStyle>
                            <HeaderStyle CssClass="pdg-headerstyle-center"></HeaderStyle>
                        </asp:BoundField>
                    </Columns>
